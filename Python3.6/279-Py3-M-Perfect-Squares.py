...
class Solution(object):#看这个，讲解在这里http://yucoding.blogspot.com/2016/12/leetcode-question-perfect-square.html
    def numSquares(self, n):#这个也会超时，真的无语了
        """
        :type n: int
        :rtype: int
        """
