# -*- coding: utf-8 -*-
"""
Created on Tue Mar  3 16:42:50 2020
...
top_k_label = tf.gather(y_data_train, top_k_indices)# y_vals_train 是120×3， [1,0,0]

sum_up_predictions = tf.reduce_sum(top_k_label, axis=1)# 这里的意思很简单，就是五个点，然后在这三个one hot中间加[1,0,0]，比如最后是个[4,0,1]，那么就是第一类
prediction = tf.argmax(sum_up_predictions, axis=1)#千万注意argmax不能求导， 非要求导就只能求softmax
