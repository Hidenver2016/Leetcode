# -*- coding: utf-8 -*-
"""
Created on Fri Jan 17 00:49:50 2020
...
嘟嘟做的
pool = [ word2 for word2 in pool if num_of_same(word,word2) == num_same]
此句是关键，根据之前试的一个长度（系统反馈长度），下面过滤出的单词至少是要在这个长度之上才有意义
"""
import random
    ...
    def findSecretWord(self, wordlist, master):
        ...
        while pool:
            ...
            if num_same == len(word):
                return word
            pool = [ word2 for word2 in pool if num_of_same(word,word2) == num_same]# 这个地方是关键，每次都要找出至少一样多的词
        return -1
